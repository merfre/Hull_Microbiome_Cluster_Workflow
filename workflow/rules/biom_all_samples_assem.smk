...
rule kraken_to_biom_assem:
  #conda:
  #"../workflow/envs/environment.yaml"
  input:
    expand("results/kraken2/{path}_assem_kraken_report.txt", path=PATHS)
  output:
    "results/biom/kraken2_assem_allsamples.biom"
  shell:
...
rule biom_to_tsv_assem:
  #conda:
  #"../workflow/envs/environment.yaml"
  input:
    "results/biom/kraken2_assem_allsamples.biom"
  output:
    report("results/biom/kraken2_assem_allsamples.tsv", caption="report/kraken2_allsamples.rst", category="Kraken2")
  shell:
    """
